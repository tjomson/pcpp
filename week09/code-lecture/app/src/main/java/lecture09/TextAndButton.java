...
class TextAndButton {
  ...
  final static Observer<Integer> display1= new Observer<Integer>() {
    @Override
...
final static Observer<Integer> display2= new Observer<Integer>() {
    @Override
    public void onSubscribe(Disposable d) {  }
    @Override
    public void onNext(Integer value) {
